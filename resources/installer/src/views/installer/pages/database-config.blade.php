    ...
    <div class="doc-inner">
        <div class="doc-wrapper w-100">
            ...
            <div class="alert alert-info">
                <strong>Note:</strong> The system will test the database connection before proceeding. Make sure your database server is running and the credentials are correct.
            </div>
