...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Start Header
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<header class="header-section position-sticky glass-effect">
    <div class="header">
            ...
            <div class="container custom-container">
                <div class="header-menu-content">
                    <nav class="navbar navbar-expand-xl p-0">
                        ...
                        <button class="navbar-toggler ms-auto ripple-effect" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav main-menu me-auto">
                                @if(page_access('personal'))
                                    <li class="nav-item dropdown"><a href="javascript:void(0);" class="has-sub animated-link">{{ __("Personal") }}
                                            <i class="fas fa-angle-down"></i></a>
                                        <div class="sub-menu glass-card">
                                                    ...
                                                    @foreach ($personal ?? [] as  $item)
                                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-10">
                                                            <a href="{{ setRoute('header.page',encrypt($item->id)) }}">
                                                                <div class="sub-menu-item feature-card">
                                                                    <div class="icon glow-border">
                                ...
                                @if(page_access('business'))
                                    <li class="nav-item dropdown"><a href="javascript:void(0);" class="has-sub animated-link">{{ __("Business") }}
                                            <i class="fas fa-angle-down"></i></a>
                                        <div class="sub-menu glass-card">
                                ...
                                @if(page_access('enterprice'))
                                    <li class="nav-item dropdown"><a href="javascript:void(0);" class="has-sub animated-link">{{ __("Enterprise") }}
                                            <i class="fas fa-angle-down"></i></a>
                                        <div class="sub-menu glass-card">
                                ...
                                @if(page_access('company'))
                                    <li class="nav-item dropdown"><a href="javascript:void(0);" class="has-sub animated-link">{{ __("Company") }}
                                            <i class="fas fa-angle-down"></i></a>
                                        <div class="sub-menu glass-card">
                                            <div class="sub-menu-wrapper">
                                                <div class="row mb-10-none">
                                ...
                                @if(page_access('developer'))
                                    <li class="nav-item dropdown">
                                        <a href="{{ setRoute("developer.index") }}" class="has-sub animated-link {{ menuActive('developer.index') }}">{{ __("Developer") }}</a>
                                    </li>
                                @endif
                            ...
                            <div class="navbar-right">
                                <ul>
                                    @if(page_access('contact'))
                                        <li class="nav-item">
                                            <a href="{{ setRoute('contact') }}" class="help-btn animated-link {{ menuActive('contact') }}">{{ __("Help") }}</a>
                                        </li>
                                    @endif
                                </ul>
                                <div class="lang-select">
                                    ...
                                    @endphp
                                    <select class="form--control langSel nice-select glass-effect">
                                ...
                                <div class="header-action">
                                    @if(auth('web')->check())
                                        <a href="{{ setRoute('user.dashboard') }}" class="btn--base btn-auth btn-premium magnetic-btn ripple-effect">{{ __("Dashboard") }}</a>
                                     @elseif(auth('agent')->check())
                                        <a href="{{ setRoute('agent.dashboard') }}" class="btn--base btn-auth btn-premium magnetic-btn ripple-effect">{{ __("Dashboard") }}</a>
                                    @elseif(auth('merchant')->check())
                                        <a href="{{ setRoute('merchant.dashboard') }}" class="btn--base btn-auth btn-premium magnetic-btn ripple-effect">{{ __("Dashboard") }}</a>
                                    @else
                                        <a href="{{ setRoute('user.login') }}" class="btn--base btn magnetic-btn ripple-effect">{{ __("Log In") }}</a>
                                        <a href="{{ setRoute('user.register') }}" class="btn--base btn-auth btn-premium magnetic-btn ripple-effect">{{ __("Sign Up") }}</a>
                                    @endif
                                </div>
