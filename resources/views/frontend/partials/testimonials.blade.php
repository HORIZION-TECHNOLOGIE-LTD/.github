...
<section class="testimonial-section ptb-120">
    <div class="container">
        ...
        <div class="testimonial-slider-wrapper scroll-reveal">
            <div class="testimonial-slider">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item glass-card">
                            <div class="testimonial-user-area">
                                <div class="user-area image-reveal">
                            ...
                            @endphp
                            <ul class="testimonial-icon-list stagger-list">
                                @for($i = 0; $i <  $rating ; $i++)
                                <li class="stagger-item"><i class="fas fa-star"></i></li>
                                @endfor
                            </ul>
                        </div>
                    </div>
                ...
                <div class="slider-nav-area">
                    <div class="slider-prev slider-nav magnetic-btn ripple-effect">
                        <i class="las la-angle-left"></i>
                    </div>
                    <div class="slider-next slider-nav magnetic-btn ripple-effect">
