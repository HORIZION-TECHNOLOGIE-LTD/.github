...
use App\Http\Controllers\Api\Merchant\WalletApiController;
...
Route::prefix('merchant')->group(function(){
    ...
    Route::middleware(['merchant.api'])->group(function(){
        ...
        Route::middleware(['CheckStatusApiMerchant','merchant.google.two.factor.api'])->group(function () {
            ...
            //wallets - comprehensive wallet management API
            Route::controller(WalletApiController::class)->prefix("wallets")->group(function(){
                Route::get('/','index');
                Route::get('/fiat','fiatWallets');
                Route::get('/crypto','cryptoWallets');
                Route::get('/balance','balance');
                Route::get('/details','details');
                Route::get('/statistics','statistics');
                Route::post('/transfer','transfer')->middleware('api.kyc');
                Route::get('/transactions','transactions');
                Route::get('/currencies','currencies');
                Route::post('/check-balance','checkBalance');
                Route::post('/update-status','updateWalletStatus')->middleware('app.mode.api');
            });
